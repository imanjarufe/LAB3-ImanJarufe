...
if __name__ == "__main__":
    ...
    with open('rockyou_mod.dic' , encoding='latin-1') as f:
        ...
        for l in f:
            S.append(l.strip())
    #ssid name
    ssid = "VTR-1645213" #CAMBIADO
    #ANonce
    aNonce = a2b_hex('4c2fb7eca28fba45accefde3ac5e433314270e04355b6d95086031b004a31935') #CAMBIADO
    #SNonce
    sNonce = a2b_hex("30bde6b043c2aff8ea482dee7d788e95b634e3f8e3d73c038f5869b96bbe9cdc") #CAMBIADO
    #Authenticator MAC (AP)
    apMac = a2b_hex("b0487ad2dc18") #CAMBIADO
    #Station address: MAC of client
    cliMac = a2b_hex("eede678cdf8b") #CAMBIADO
    #The first MIC
    mic1 = "1813acb976741b446d43369fb96dbf90" #CAMBIADO
    #The entire 802.1x frame of the second handshake message with the MIC field set to all zeros
    ...
    mic2 = "a349d01089960aa9f94b5857b0ea10c6" #CAMBIADO
    #The entire 802.1x frame of the third handshake message with the MIC field set to all zeros
    ...
    #The third MIC
    mic3 = "5cf0d63af458f13a83daa686df1f4067" #CAMBIADO
    #The entire 802.1x frame of the forth handshake message with the MIC field set to all zeros
